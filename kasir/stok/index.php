...
.btn-transparent.float-end:hover {
          ...
          <div class="card shadow"> 
            ...
            <div class="card-body">
              ...
              <p class="card-text">Rp. <?php echo number_format($data['harga']) ?></p>
               <a href="tambah.php?id_produk=<?=$data['id_produk']?>" class="btn btn-transparent1">Restock</a>
               <a href="../produk/edit.php?id_produk=<?=$data['id_produk']?>" class="btn btn-transparent float-end">Edit</a>
